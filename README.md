...
21/09 I noticed all the photos have the little rectangle in the same place so i tried to run it without random rotations to see if it works better, but it performed worse. I also changed the order of augmentation but it performed worse, hence I have left it as it is.
